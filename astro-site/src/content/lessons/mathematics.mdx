...
chapter: 0
order: 0
description: 向量、范数、点积、矩阵、极坐标、复数与高维旋转。
---
...
前六章是核心基础，第七章是进阶推导，第八、九章把平面几何接到实际注意力头。读完后继续 [01 位置编码](/lessons/position-encoding)。
...
本篇的图解、手算例和教学路线是为讲解组织的内容。接下来阅读 [01 位置编码](/lessons/position-encoding)，看模型为什么需要这些数学结构，以及怎样把它们应用到 Q/K。
