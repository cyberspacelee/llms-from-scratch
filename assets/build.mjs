...
<body>
<header><div class="switch"><a href="../training/position-encoding.html">训练 Training</a><a href="../inference/position-encoding-and-kv-cache.html">推理 Inference</a><a href="${lesson.code}">PyTorch 源码</a></div>
